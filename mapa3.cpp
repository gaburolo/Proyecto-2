#ifndef PRUEBAS22_MAPA_3
#define PRUEBAS22_MAPA_3
...
private:
    ...
    Sprite ene21=Sprite("Enemigo",'n',7,1);
    Sprite ene22=Sprite("Enemigo",'n',7,2);
    Sprite ene23=Sprite("Enemigo",'n',7,1);
    Sprite ene24=Sprite("Enemigo",'n',7,0);
    Sprite ene25=Sprite("Enemigo",'n',7,1);
    Sprite ene26=Sprite("Enemigo",'n',7,2);
    Sprite ene27=Sprite("Enemigo",'n',7,1);
    Sprite ene28=Sprite("Enemigo",'n',7,0);
    Sprite ene29=Sprite("Enemigo",'n',7,1);
    Sprite ene30=Sprite("Enemigo",'n',7,2);
    Sprite ene31=Sprite("Enemigo",'n',7,1);
    Sprite ene32=Sprite("Enemigo",'n',7,1);
    Sprite ene33=Sprite("Enemigo",'n',7,0);
    Sprite ene34=Sprite("Enemigo",'n',7,1);
    Sprite ene35=Sprite("Enemigo",'n',7,2);
    Sprite ene36=Sprite("Enemigo",'n',7,1);
public:
    mapa3(){
        crearLista();
